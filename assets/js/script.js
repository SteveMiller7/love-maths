...
function runGame(gameType) {
    ...
    if (gameType === "addition" ) {
        ...
        let num3 = Math.floor(Math.random() *250) +1;
        let num4 = Math.floor(Math.random() *250) +1;
...
function calculateCorrectAnswer() {
    ...
    if (operator === "+") {
        return [operand1 + operand2, "addition"]; // retrurns value of operand 1 + operand2. Then tells that we want to continue with "addition" game
    }   else if (operator === "x") {
